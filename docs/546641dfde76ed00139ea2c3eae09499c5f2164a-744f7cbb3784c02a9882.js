/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-744f7cbb3784c02a9882.js.LICENSE.txt */
  ...
  [98],
  {
                ...
                toString: function () {
                  return (function (e, t, n, r) {
                    var i = ue(n),
                      a = oe(t);
                    return i
                      ? '<' + e + ' data-react-helmet="true" ' + i + '>' + G(a, r) + '</' + e + '>'
                      : '<' + e + ' data-react-helmet="true">' + G(a, r) + '</' + e + '>';
      ...
      var s = function (e) {
          function t(e, r, l, c, f) {
              ...
              if (
                ...
                switch (m) {
                  case 123:
                              ...
                              e: {
                                for (L = R + 1; L < H; ++L)
                                  switch (l.charCodeAt(L)) {
                                    case 47:
                                      if (42 === m && 42 === l.charCodeAt(L - 1) && R + 2 !== L) {
                                        R = L + 1;
                                        break e;
                                      }
                                      break;
                    ...
                    (q += h), (h = D = _ = L = p = 0), (Z = ''), (m = l.charCodeAt(++R));
                    break;
                  case 125:
                  case 59:
              ...
              switch (m) {
                ...
                case 10:
                  47 === k
                    ...
                    0 < z * M && s(0, Z, r, e, O, T, $.length, c, f, c),
                    (T = 1),
                    O++;
                  break;
                case 59:
            ...
            if (0 < (F = $.length)) {
              if (
                ((_ = r),
                0 < z && void 0 !== (x = s(2, $, _, e, O, T, F, c, f, c)) && 0 === ($ = x).length)
              )
                return W + $ + q;
              if ((($ = _.join(',') + '{' + $ + '}'), 0 != I * N)) {
                switch ((2 !== I || a($, 2) || (N = 0), N)) {
                  case 111:
                    $ = $.replace(y, ':-moz-$1') + $;
                    break;
                  case 112:
          ...
          function a(e, t) {
            ...
            return (
              (n = e.substring(n + 1, e.length - 1)), L(2 !== t ? r : r.replace(C, '$1'), n, t)
            );
          }
          function o(e, t) {
          ...
          function c(e, n) {
            ...
            var a = t(j, r, n, 0, 0);
            return (
              0 < z && void 0 !== (i = s(-2, a, r, r, O, T, a.length, 0, 0, 0)) && (a = i),
              '',
              (N = 0),
              (T = O = 1),
              a
              ...
              if (
                ...
                if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
                  ...
                  var a = ge(this.rules, e, t, n).join(''),
                    o = Y(V(this.baseHash, a.length) >>> 0);
    ...
    4741: function (e, t, n) {
                ...
                r.createElement(
                  ...
                  o && i
                    ...
                    : r.createElement(
                        L,
                        null,
                        r.createElement(Qe, { isHome: i }),
                        r.createElement(st, { isHome: i }),
      ...
      var $ = {
        ...
        key: function (e) {
          return (
            !R.hasOwnProperty(e) && !_.hasOwnProperty(e) && 'targets' !== e && 'keyframes' !== e
          );
        },
      };
      function q(e) {
      ...
      function W(e, t) {
        var n = q(e),
          r = B($.und(n[0]) ? 1 : n[0], 0.1, 100),
          i = B($.und(n[1]) ? 100 : n[1], 0.1, 100),
          a = B($.und(n[2]) ? 10 : n[2], 0.1, 100),
          o = B($.und(n[3]) ? 0 : n[3], 0.1, 100),
          s = Math.sqrt(i / r),
          l = a / (2 * Math.sqrt(i * r)),
      ...
      function ae(e, t) {
        var n = re(e);
        for (var r in t) n[r] = $.und(e[r]) ? t[r] : e[r];
        return n;
      }
      function oe(e) {
        return $.rgb(e)
      ...
      function ue(e, t, n) {
        if (ne([n, 'deg', 'rad', 'turn'], se(t))) return t;
        var r = F.CSS[t + n];
        if (!$.und(r)) return r;
      ...
      function fe(e, t) {
        return $.dom(e) && !$.inp(e) && (!$.nil(ce(e, t)) || ($.svg(e) && e[t]))
          ? 'attribute'
          : $.dom(e) && ne(D, t)
          ? 'transform'
          : $.dom(e) && 'transform' !== t && de(e, t)
          ? 'css'
          : null != e[t]
          ? 'object'
          : void 0;
      ...
      function xe(e) {
        ...
        switch (e.tagName.toLowerCase()) {
          ...
          case 'line':
            return (function (e) {
              return be({ x: ce(e, 'x1'), y: ce(e, 'y1') }, { x: ce(e, 'x2'), y: ce(e, 'y2') });
            })(e);
          case 'polyline':
            return ye(e);
          case 'polygon':
      ...
      function we(e, t) {
        var n = t || {},
          r =
            n.el ||
            (function (e) {
              for (var t = e.parentNode; $.svg(t) && $.svg(t.parentNode); ) t = t.parentNode;
              return t;
            })(e),
      ...
      function ke(e, t) {
        var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
          r = ve($.pth(e) ? e.totalLength : e, t) + '';
        return {
          original: r,
          numbers: r.match(n) ? r.match(n).map(Number) : [0],
          strings: $.str(e) || t ? r.split(n) : [],
        };
      }
      function Ce(e) {
        return K(e ? ee($.arr(e) ? e.map(te) : te(e)) : [], function (e, t, n) {
      ...
      function Ae(e, t) {
        var n = re(t);
        if ((/^spring/.test(n.easing) && (n.duration = W(n.easing)), $.arr(e))) {
          var r = e.length;
          2 === r && !$.obj(e[0])
            ? (e = { value: e })
            : $.fnc(t.duration) || (n.duration = t.duration / r);
        }
        var i = $.arr(e) ? e : [e];
        return i
          .map(function (e, n) {
            var r = $.obj(e) && !$.pth(e) ? e : { value: e };
            return (
              $.und(r.delay) && (r.delay = n ? 0 : t.delay),
              $.und(r.endDelay) && (r.endDelay = n === i.length - 1 ? t.endDelay : 0),
              r
            );
          })
          .map(function (e) {
      ...
      function Te(e, t) {
                ...
                var t = K(
                  ...
                  r = function (r) {
                    ...
                    n[i] = e.map(function (e) {
                      var t = {};
                      for (var n in e) $.key(n) ? n == i && (t.value = e[n]) : (t[n] = e[n]);
                      return t;
                    });
                  },
                  i = 0;
        ...
        t))
          $.key(i) && n.push({ name: i, tweens: Ae(t[i], e) });
        return n;
      }
      function Oe(e, t) {
        var n;
        return e.tweens.map(function (r) {
          ...
          return (
            ...
            (i.isPath = $.pth(a)),
            (i.isPathTargetInsideSVG = i.isPath && $.svg(t.target)),
            (i.isColor = $.col(i.from.original)),
            i.isColor && (i.round = 1),
            (n = i),
            i
          );
      ...
      var Le = [],
        Me = (function () {
          var e;
          function t(n) {
            for (var r = Le.length, i = 0; i < r; ) {
              var a = Le[i];
              a.paused ? (Le.splice(i, 1), r--) : (a.tick(n), i++);
            }
          ...
          return (
            ...
            function () {
              e ||
                (Re() && _e.suspendWhenDocumentHidden) ||
                !(Le.length > 0) ||
      ...
      function _e(e) {
        ...
        function d() {
          (n = 0), (r = u(l.currentTime) * (1 / _e.speed));
        }
        function f(e, t) {
        ...
        function p(e) {
          for (var t = 0, n = l.animations, r = n.length; t < r; ) {
            ...
            for (
              var u = B(e - c.start - c.delay, 0, c.duration) / c.duration,
              ...
              (b = c.isPath ? Ee(c.value, d * y, c.isPathTargetInsideSVG) : x + d * (y - x)),
        ...
        return (
          ...
          (l.play = function () {
            l.paused && (l.completed && l.reset(), (l.paused = !1), Le.push(l), d(), Me());
          }),
          (l.reverse = function () {
      ...
      (_e.version = '3.2.1'),
        ...
        (_e.path = function (e, t) {
          var n = $.str(e) ? Q(e)[0] : e,
            r = t || 100;
          return function (e) {
            return { property: e, el: n, svg: we(n), totalLength: xe(n) * (r / 100) };
          };
        }),
          ...
          return (
            ...
            (t.add = function (n, r) {
              ...
              (l.autoplay = !1),
                ...
                (l.timelineOffset = $.und(r) ? c : ge(r, c)),
                o(t),
      ...
      var Be = _e,
              ...
              return (
                Be.timeline({
                  ...
                  .add({
                    ...
                    strokeDashoffset: [Be.setDashoffset, 0],
                  })
        ...
        Xe = c.ZP.nav.withConfig({ displayName: 'nav__StyledNav', componentId: 'sc-1wr9n3a-1' })(
          [
            '',
        ...
        Je = c.ZP.div.withConfig({ displayName: 'nav__StyledLinks', componentId: 'sc-1wr9n3a-2' })(
          [
        ...
        Qe = function (e) {
          ...
          var p = t ? Ye.Cs : 0,
            ...
            g = r.createElement(
              ...
              t
                ? r.createElement('a', { href: '/', 'aria-label': 'home' }, '⌂')
                : r.createElement(o.Link, { to: '/', 'aria-label': 'home' }, '⌂'),
            ),
            v = r.createElement(
              'a',
              {
        ...
        Ke = n(18),
        et = c.ZP.div.withConfig({ displayName: 'menu__StyledMenu', componentId: 'sc-g8kun9-0' })([
        ...
        rt = function () {
          ...
          (0, r.useEffect)(function () {
            return (
              ...
              (e = [c.current].concat((0, Ke.Z)(Array.from(u.current.querySelectorAll('a'))))),
              (t = e[0]),
              (n = e[e.length - 1]),
              function () {
              ...
              l
                ...
                : r.createElement(
                    ...
                    o &&
                      r.createElement(
                        We.Z,
                        { classNames: n ? 'fade' : '', timeout: n ? Ye.Cs : 0 },
                        t,
                      ),
                  ),
            )
        ...
        st = function (e) {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              null,
              Ge.socialMedia &&
                Ge.socialMedia.map(function (e, t) {
                  var n = e.url,
                    i = e.name;
                  return r.createElement(
                    'li',
        ...
        ct = function (e) {
          ...
          return r.createElement(
            ...
            r.createElement(
              lt,
              null,
              r.createElement('a', { href: 'mailto:' + Ge.email }, Ge.email),
            ),
          );
        },
        ut = c.ZP.footer.withConfig({
          ...
          return (
            ...
            r.createElement(
              ...
              r.createElement(
                ft,
                { tabindex: '-1' },
                r.createElement('div', null, ' With ♥ from Ayush Anand'),
                r.createElement(
                  'a',
                  { href: 'https://github.com/bchiang7/v4' },
                  r.createElement('div', null, 'Design by Brittany Chiang'),
                  t.stars &&
                    t.forks &&
                    r.createElement(
                      'div',
        ...
        ht = function () {
          ...
          var a = [
            r.createElement('h1', null, r.createElement('br', null), 'Hi, my name is'),
            r.createElement('h2', { className: 'big-heading' }, 'Ayush Anand.'),
            r.createElement('h3', { className: 'big-heading' }, 'I am a web and AI developer.'),
            r.createElement(
              r.Fragment,
              null,
              r.createElement(
              ...
              : r.createElement(
                  ...
                  t &&
                    a.map(function (e, t) {
                      return r.createElement(
                        We.Z,
                        { key: t, classNames: 'fadeup', timeout: Ye.Cs },
        ...
        yt = c.ZP.div.withConfig({ displayName: 'about__StyledText', componentId: 'sc-74mrz9-1' })([
        ...
        xt = c.ZP.div.withConfig({ displayName: 'about__StyledPic', componentId: 'sc-74mrz9-2' })(
          [
        ...
        wt = function () {
          var e = (0, r.useRef)(null),
            t = (0, Ve.Tb)();
          (0, r.useEffect)(function () {
            t || vt.Z.reveal(e.current, (0, Ge.srConfig)());
          }, []);
          var i = [
            'Python',
            'PyTorch',
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'p',
                    null,
                    r.createElement('h4', null, 'Things I do'),
                    r.createElement(
                      'ul',
                      null,
                      r.createElement(
                    ...
                    r.createElement('h4', null, "Projects I'm working on"),
                    r.createElement(
                      'ul',
                      null,
                      r.createElement(
                    ...
                    r.createElement('h4', null, 'Things I did previously'),
                    r.createElement(
                      'ul',
                      null,
                      r.createElement(
              ...
              r.createElement(
                ...
                r.createElement('br', null),
                r.createElement('h1', null, 'Education'),
                r.createElement(
                  'div',
                  null,
                  r.createElement('br', null),
                  r.createElement('h3', null, 'National Institute of Technology Durgapur, India '),
                  'Bachelor of Technology in Computer Science and Engineering, ',
                  r.createElement('i', null, 'Expected 2025'),
                  r.createElement(
                    'i',
                    null,
                    r.createElement(
                      ...
                      r.createElement(
                        ...
                        null,
                        ' ',
                        r.createElement('b', null, 'Courses'),
                      ...
                      r.createElement(
                        ...
                        null,
                        ' ',
                        r.createElement('b', null, 'Organisations'),
        ...
        Ot = function () {
          var e = (0, o.useStaticQuery)('2009693873').jobs.edges,
            ...
            d = (0, Ve.Tb)();
          (0, r.useEffect)(function () {
            d || vt.Z.reveal(u.current, (0, Ge.srConfig)());
          }, []);
          (0, r.useEffect)(
            function () {
              c.current[s]
          ...
          return r.createElement(
            Et,
            { id: 'jobs', ref: u },
            r.createElement('h2', { className: 'numbered-heading' }, 'Experience'),
            r.createElement(
              'div',
              { className: 'inner' },
              r.createElement(
                ...
                r.createElement(St, { activeTabId: n }),
              ),
              r.createElement(
                At,
                null,
        ...
        jt = function () {
          var e = (0, o.useStaticQuery)('4162897811').featured.edges.filter(function (e) {
              return e.node;
            }),
            t = (0, r.useRef)(null),
            n = (0, r.useRef)([]),
          ...
          return (
            (0, r.useEffect)(function () {
              i ||
                (vt.Z.reveal(t.current, (0, Ge.srConfig)()),
                n.current.forEach(function (e, t) {
                  return vt.Z.reveal(e, (0, Ge.srConfig)(100 * t));
                }));
            }, []),
            r.createElement(
              'section',
                    ...
                    return r.createElement(
                      ...
                      r.createElement(
                        ...
                        r.createElement(
                          'a',
                          { href: s || u || '#' },
                          r.createElement(gt.G, { image: p, alt: l, className: 'img' }),
                        ),
                      ),
                    );
                  }),
        ...
        Lt = function () {
          ...
          (0, r.useEffect)(function () {
            c ||
              (vt.Z.reveal(a.current, (0, Ge.srConfig)()),
              vt.Z.reveal(s.current, (0, Ge.srConfig)()),
              ...
              c
                ? r.createElement(
                    ...
                    f &&
                      f.map(function (e, t) {
                        var n = e.node;
                        return r.createElement(zt, { key: t }, p(n));
                      }),
                  )
                : r.createElement(
                    qe.Z,
    ...
    355: function (e, t, n) {
      ...
      function j(e, t) {
        ...
        return t.reveal || i ? P.call(this, e, r) : t.reset || a ? z.call(this, e) : void 0;
      }
      function P(e, t) {
        var n = [
        ...
        try {
          ...
          var c = l.reduce(function (e, n) {
            ...
            l
              ...
              : ((s.id = N()), (s.node = n), (s.seen = !1), (s.revealed = !1), (s.visible = !1));
        ...
        void 0 === e && (e = { type: 'init' }),
          ...
          m(function () {
            ...
            b(n.store.containers, function (e) {
              ...
              b(t, function (e) {
                e.sequence ? M.call(n, e) : j.call(n, e);
              }),
              (n.pristine = !1);
          });
      }
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-744f7cbb3784c02a9882.js.map
